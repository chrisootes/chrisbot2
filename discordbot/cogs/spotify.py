...
class SpotifyCommands:
    ...
    def __init__(self, bot):
        ...
        self.spotify_id = config.get('spotify', 'client_id')
        self.spotify_secret = config.get('spotify', 'client_secret')
        self.spotify_refresh = config.get('spotify', 'refresh_token')
    ...
    async def stop(self, ctx):
        ...
        elif ctx.message.author.id == config.get('DEFAULT', "owner_id"):
